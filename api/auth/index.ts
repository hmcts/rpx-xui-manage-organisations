    ...
    if (!accessToken || expired) {
        ...
        if (check) {
           ...
           // axios.defaults.headers.common.Authorization = `Bearer ${session.auth.token}`
            axios.defaults.headers.common.Authorization = `Bearer eyJ0eXAiOiJKV1QiLCJ6aXAiOiJOT05FIiwia2lkIjoicDBZL0lpN0txdS9uZndIK0RvdmZVMEszbHRJPSIsImFsZyI6IlJTMjU2In0..QzztBxSucJOLiALhOs6hBlHsmh_PtajNmHXGNqIwqLXcGcuA2sv01IP5MbSskoFph2VpMjJrSKbrwkixM-U4P1gapk6sOeuQGNxHT-LVbrgRvKY6bGPyBDmB155vbqSeMLGCFhJsFdX2pDyb1kFXpe9gZyBzHoIq5h5dpNzJkXV0Vze2gxJ189ryZndQm1Xm3kry2WkyD4wi7p_g3QBmXuVkNvlD1-dBE-tKxJv4IPOCsrqp66rS-4RfxAgflvu2sUgkzt7ZYCxnVWsuQOCKq38ibLQJUorDatvPFJi7BNWU3CBItFi4OMERd-QJdhnruYGRpwZ5YtL5P042DGEXeg`
