...
export function handleCondition(conditionNode, variables): any {
...
export function handleState(stateNode, variables): any {
...
export function handleInstruction(instruction, stateId, variables): any {
