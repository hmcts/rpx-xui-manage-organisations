  ...
  template: `
    <ng-container [formGroup]="group">
      <div class="govuk-checkboxes__item">
        <input class="govuk-checkboxes__input" type="checkbox" [id]="config.group" [name]="config.name" [formControlName]="config.name"
...
export class GovUkCheckboxComponent {
  ...
  @Input() config: { label: string, hint: string; name: string; group: string};
