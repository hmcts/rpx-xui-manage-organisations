...
describe('AccessDeniedComponent', () => {
  ...
  it('should show the Manage Organisations access denied message', () => {
    ...
    expect(headingElement.textContent).toContain('You cannot use Manage Organisations with this account');
    expect(translatePipeSpy).toHaveBeenCalledWith('You cannot use Manage Organisations with this account');
    ...
    expect(bodyElements[0].nativeElement.textContent).toContain(
      'You signed in successfully, but this account is not authorised to use Manage Organisations.'
    );
