...
export class UnassignedCasesService {
    ...
    public fetchUnassignedCases(caseTypeId: string, pageNo: number, pageSize: number): Observable<any> {
         const url = `${UnassignedCasesService.unassignedCasesUrl}?caseTypeId=${caseTypeId}&pageNo=${pageNo}&pageSize=${pageSize}`;
