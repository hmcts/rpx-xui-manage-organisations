...
describe('Share a Case Page', function () {
    ...
    it('Page Layout and elements', async function () {
    ...
    it('OpenAll Close AllO', async function () {
        await MockApp.startServer();
        await BrowserUtil.browserInitWithAuth();
        await BrowserUtil.waitForLD();
        let headerTabs = await headerPage.getHeaderTabs();
    ...
    it('Expand Collapse Individual case', async function () {
        await MockApp.startServer();
        await BrowserUtil.browserInitWithAuth();
        await BrowserUtil.waitForLD();
        let headerTabs = await headerPage.getHeaderTabs();
    ...
    it('Case Users list sort order', async function () {
        await MockApp.startServer();
        await BrowserUtil.browserInitWithAuth();
        await BrowserUtil.waitForLD();
        let headerTabs = await headerPage.getHeaderTabs();
    ...
    it('Unassigned cases Tab without role pui-caa', async function () {
